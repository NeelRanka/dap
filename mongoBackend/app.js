...
mongoose.connect('mongodb+srv://NeelRanka:MongoPassword@cluster0.gqxm3.mongodb.net/dap?retryWrites=true&w=majority', {useNewUrlParser: true}, (err) => {
    if (!err) {
...
app.get("/", (req,resp) => {
    ...
    delivery_boi.find({}, function(err, users) {
        var userMap = {};
